    ...
    menu_{}
{
    ...
    render_->AddUnitTexture(Render::LoadTexture("textures/Map.rgba", 1024, 1024), UnitType::Map, 620.0f, 620.0f);
    ...
    render_->AddUnitTexture(Render::LoadTexture("textures/Rocket.rgba", 64, 64), UnitType::Rocket, 40.0f, 30.0f);
